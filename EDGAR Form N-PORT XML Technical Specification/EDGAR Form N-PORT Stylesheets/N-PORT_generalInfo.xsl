		...
		<table>
				...
				<td>
					<div class="fakeBox2">
						<xsl:call-template name="stateDescription">
							<xsl:with-param name="stateCode"		select="string(m1:genInfo/m1:regStateConditional/@regState)" />
						</xsl:call-template>
						<span>
							<xsl:text>&#160;</xsl:text>
						</span>
			...
			<tr>
				...
				<td>
					<div class="fakeBox4">
						<xsl:call-template name="stateDescription">
							<xsl:with-param name="stateCode"		select="string(m1:genInfo/m1:regStateConditional/@regCountry)" />
						</xsl:call-template>
						<span>
							<xsl:text>&#160;</xsl:text>
						</span>
